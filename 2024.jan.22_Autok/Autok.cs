...
namespace _2024.jan._22_Autok
{
    internal class Autok
    {
        ...
        public DateTime Gyartasiev { get => gyartasiev; set => gyartasiev = value; }
        ...
        public Autok(string rendszam, string marka, string modell, DateTime gyartasiev, DateTime forgalmiErvenyesseg, int vetelar, int kmallas, int hengerurtartalom, int tomeg, int teljesitmeny)
        {
            Rendszam = rendszam;
            Marka = marka;
            Modell = modell;
